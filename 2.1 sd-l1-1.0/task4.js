...
for (let i = 1; i < 106; i++) { //* Bucle for de 106 para que se imprima 105 veces
  ...
  if (i % 7 == 0) esMultiplo += "Woof"; //* "" Con multiplos de 7
  //? Con este metodo se imprimen las palabras cuando las condiciones se cumplen y van en cascada para que salgan en orden

  console.log(esMultiplo || i); //* Utilizo el operador OR para imprimir tanto mi variable como mi indice dependiendo si se cumple o no la condicion
}
